...
# prefer root p1version2_data.sql (generated by scripts) if present
SQL_FILE = Path('p1version2_data.sql') if Path('p1version2_data.sql').exists() else Path('sql/p1version2_data.sql')
OUT_DIR = Path('output')
